...
<head>
    ...
    <title>Tugas pertemuan 3 PHP</title>
...
$total_column = count($mahasiswa);
$jumlah_all_nilai = array_sum($jumlah_nilai);
$nilai_rata2 = $jumlah_all_nilai / $total_column;
$agregate = ['Nilai Tertinggi'=>$nilai_tertinggi, 'Nilai Terendah'=>$nilai_terendah, 'Nilai Rata-rata'=>$nilai_rata2, 'Jumlah Siswa'=>$total_column, 'Jumlah Total Nilai'=>$jumlah_all_nilai];
...
<div class="container pt-5">
    ...
    <tfoot>
        <?php foreach($agregate as $agr => $hasil){
            ?>
            <tr>
                <td colspan='4'><?= $agr ?> : </td>
