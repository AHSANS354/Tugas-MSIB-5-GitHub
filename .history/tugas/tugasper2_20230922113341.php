...
<body>
    <h1>Input Data</h1>
    <form method="POST">
        <div class="row d-flex flex-column gap-3 ms-3">
            <!-- input nama -->
            <div class="col">
        ...
        <div class="col">
            ...
            <input type="radio" name="hobby" id="hobby1" value="Hobby 1">
            <label for="hobby1">Hobby 1</label>
            <input type="radio" name="hobby" id="hobby2" value="Hobby 2">
            <label for="hobby2">Hobby 2</label>
            <input type="radio" name="hobby" id="hobby3" value="Hobby 3">
            <label for="hobby3">Hobby 3</label>
            <input type="radio" name="hobby" id="hobby4" value="Hobby 4">
            <label for="hobby4">Hobby 4</label>
            <input type="radio" name="hobby" id="hobby5" value="Hobby 5">
            <label for="hobby5">Hobby 5</label>
            <input type="radio" name="hobby" id="hobby6" value="Hobby 6">
            <label for="hobby6">Hobby 6</label>
            <input type="radio" name="hobby" id="hobby7" value="Hobby 7">
            <label for="hobby7">Hobby 7</label>
            <input type="radio" name="hobby" id="hobby8" value="Hobby 8">
            <label for="hobby8">Hobby 8</label>
            <input type="radio" name="hobby" id="hobby9" value="Hobby 9">
            <label for="hobby9">Hobby 9</label>
            <input type="radio" name="hobby" id="hobby10" value="Hobby 10">
            <label for="hobby10">Hobby 10</label>
        </div>
