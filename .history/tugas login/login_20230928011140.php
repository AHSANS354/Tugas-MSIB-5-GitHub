...
<html lang="en">
  ...
  <style>
    body{
        background: url("images/wp_login.jpg");
  ...
  <body>
    <div class="container d-flex justify-content-center align-items-center p-5 mt-5">
        <div class="row text-center rounded shadow-lg">
            <div class="col mt-4 mb-4 text-light">
                <h1>MASUK</h1>
            </div>
            <div class="row d-flex flex-column mb-4">
                <form action="" method="post">
                    <div class="col-auto text-light fw-bold">
            ...
            <footer class="mt-4 mb-4 text-light">&copy; Khasan || MSIB 5 2023</footer>
        </div>
    </div>
    <?php
