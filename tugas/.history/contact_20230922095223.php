      ...
      <div class="content">
        <div class="row mt-5 pt-5">
          <div class="col d-flex flex-column">
            <a href="https://www.linkedin.com/in/khasan-dullatif/" target="_blank" class="d-flex align-items-center gap-3 text-light text-decoration-none"><i class="bi bi-linkedin text-info"><?= $linkedin ?></i></a>

            <a href="https://www.instagram.com/_ahsans_/" target="_blank" class="d-flex align-items-center gap-3 text-light text-decoration-none"><i class="bi bi-instagram" style="color: #c13584"><?= $insta ?></i></a>
