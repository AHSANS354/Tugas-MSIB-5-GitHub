    ...
    <div class="home">
      <div class="row">
        <ul class="nav fixed-top justify-content-center bg-dark p-3 gap-3 shadow">
          <li class="nav-item">
            <a class="nav-link text-warning" href="home.html">Home</a>
          </li>
          <li class="nav-item">
            <a class="nav-link text-warning" href="portofolio.html">Portofolio</a>
          </li>
          <li class="nav-item">
      ...
      <div class="row mt-5 pt-5 d-flex align-items-center">
        ...
        <div class="col-4 shadow p-5 text-light">
          <h1>Khasan Dullatif</h1>
          <p><strong>Junior Web Developer</strong></p>
          <p>
            Saya menguasai HTML, CSS, Javasript, Jquery, Bootstrap, React Js, Vue Js, Next Js <br />
            Selalu belajar dan senang menambahkan pengalamam baru adalah Moto saya
          </p>
        </div>
      </div>
    </div>
    <footer class="footer text-light text-center">&copy; Khasan Dullatif || 2023</footer>
